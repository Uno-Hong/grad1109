...
%>
	<form action="CsWriteProc.jsp" method="post" id="CsForm" accept-charset ="UTF-8">
	<div align="center">
		...
		<table width="auto" border="3" bordercolor="lightgray" align="center">
			<tr>
				<td id="title">작성자</td>
				<td>
					<input type="text" name="cs_id" value="${sessionScope.sessionID}">
				</td>
			</tr>
			<tr>
				<td id="title">제목</td>
				<td>
					<input type="text" name="cs_title" size="100%" maxlength="100" value="">
				</td>
			</tr>
			<tr>
				<td id="title">내용</td>
				<td>
					<textarea name="cs_article" rows="20" cols="72"></textarea>
				</td>
			</tr>
			<!-- <tr>
				<td id="title">첨부파일</td>
